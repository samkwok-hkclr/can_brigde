...
def create_can_sender_node(interface, node_name, enable_can_fd, namespace):
    """
    ...
    node = LifecycleNode(
        ...
        output='screen',
        sigterm_timeout="5", # Set SIGTERM timeout to 5 seconds
        prefix=['chrt -r 80'], # Realtime priority
    )
...
def generate_launch_description():
    ...
    launch_actions.extend([
        ...
        DeclareLaunchArgument('timeout_sec', description=''),
    ...
    launch_actions.extend(
        create_can_sender_node(
            interface=LaunchConfiguration('interface'),
            node_name=[
                LaunchConfiguration('interface'), TextSubstitution(text='_sender')],
